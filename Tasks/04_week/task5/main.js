...
const randomHexColor = () => {
  return "#" + Math.floor(Math.random() * 16777215).toString(16); // googled this from the webs
};

colorChangeBtn.addEventListener("click", () => {
  document.body.style.color = randomHexColor(); //changes the text color
  document.body.style.backgroundColor = randomHexColor(); //change the background color
});
